...
class StrategyParameterTemplate:
    ...
    PARAMETER_DEFINITIONS = {
        ...
        "required_oversold_confirmation": {
            "type": "boolean",
            "label": "Require Oversold Confirmation",
    ...
    def create_template_for_strategy(self, strategy_id: str) -> Dict[str, Any]:
        ...
        sections = [
            (
                "position_parameters",
                "Position Parameters",
                "Configure position sizing and targets",
            ),
    ...
    def create_parameter_field(
        self, param_name: str, param_value: Any, category: str
    ) -> Optional[ParameterField]:
