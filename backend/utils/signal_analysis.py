...
class SignalAnalyzer:
    ...
    def detect_volatility_regime(
        atr: float, current_price: float, historical_atr: List[float]
    ) -> str:
    ...
    def analyze_advanced_signals(
        cls, indicators: Dict[str, Any], current_price: float
    ) -> MarketSignals:
        """
        ...
        trend_direction = cls.detect_trend_direction(
...
class ProbabilityCalculator:
    ...
    def calculate_probability_profit(
        signals: MarketSignals, delta_target: float, dte: int
    ) -> float:
    ...
    @staticmethod
    def calculate_spread_probability_profit(
        signals: MarketSignals, delta_target: float, dte: int
    ) -> float:
        """Calculate probability of profit for credit spreads specifically"""
        base_prob = ProbabilityCalculator.calculate_probability_profit(
            signals, delta_target, dte
        )
